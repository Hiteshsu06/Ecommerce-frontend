    ...
    <>
      {loader ? <Loading /> :
        <>
          ...
          {/* Hero Section */}
          <div className="flex flex-col lg:flex-row items-center bg-yellow-50">
            ...
            <div className="w-full lg:w-2/5 flex flex-col px-4 lg:pl-10 py-6 justify-center space-y-4">
              ...
              <p className="text-base">Anand sweets, sweetening celebrations since 1988</p>
          ...
          <section className="container mx-auto grid md:grid-cols-2 gap-8 px-4 py-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <p>
                Anand owes its success to its know-how that is the culmination of tradition, innovation and uncompromising quality. The dynamism of Anand is also the result of its unrelenting quest to restyle and update its product range, packaging, to cater to the changing demographic and dynamics of changing India.
              </p>
            </div>
          </section>
