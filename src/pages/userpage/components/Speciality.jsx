            ...
            <div className=" flex 2 bg-[#ede9dd]">
                <div className="w-[35%] py-24 pl-[2rem]">
                    <div className="card flex flex-col justify-start items-start border-[#af2037] border-l-8 rounded-md p-12">
                        ...
                        <button className="px-8 py-2 text-white bg-[#caa446] rounded-md transition-all duration-300 border-2 border-transparent hover:bg-transparent hover:text-yellow-600 hover:border-yellow-600">
                            {t("see_all")}
                        </button>
                    </div>
                </div>
