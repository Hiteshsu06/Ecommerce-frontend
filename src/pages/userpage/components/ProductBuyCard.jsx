    ...
    <div className="flex flex-col select-none">
        ...
        <div class="flex items-center gap-2 mt-2">
            <div class="flex items-center border-2 border-[#caa446] rounded-md overflow-hidden min-w-[113px]">
                <button class="px-3 py-2 text-lg hover:bg-gray-200 w-fit" onClick={decreaseQty}
            ...
            <button 
                ...
                class="bg-[#caa446] hover:bg-[#b29238] w-full text-white font-semibold border border-black px-4 py-2 rounded-md h-full">
                {t("add_to_cart")}
            </button>
        </div>
    </div>
