...
const Footer = () => {
    return (
        <footer className="w-full py-2">
            <div className="w-full bg-[#fffbf5] px-10">
                <div
                    ...
                    <div
                        ...
                        <img src={shopdata.logo2} alt='' className="w-[154px]" />
                    </div>
                </div>
                <div className="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
                    <div
                        ...
                        {shopdata.category.map((item, index) => {
                            return (
                    ...
                    <div className="block  md:w-[50%]">
                        ...
                        <div className='shop-detail w-full flex gap-28 mt-8'>
                            <div className="timing">
                                ...
                                <div className=" text-gray-600 font-medium hover:text-gray-900">{shopdata.timing.days}</div>
                                <div className=" text-gray-600 font-medium hover:text-gray-900">{shopdata.timing.time}</div>
                            </div>
                            <div className="email">
                                <p className='font-semibold pb-4'>Email:</p>
                                <a href={`mailto:${shopdata.email}`} className="no-underline text-gray-600 font-medium hover:text-gray-900">{shopdata.email}</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="py-9 px-10 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
                    <span className="text-sm text-gray-500 ">© {new Date().getFullYear()} Copyright. <a href={shopdata.website}>{shopdata.title}</a>, All rights reserved.</span>
