    ...
    return (
        <div className="flex flex-col justify-center items-center p-10">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-10 px-20 py-5 justify-center items-center">
                    ...
                    <img src="https://www.anandsweets.in/cdn/shop/files/iso_edb97c4a-6d94-4ffc-96cc-c17016c17130.svg?v=1684409274" alt="Trust Us" />
                    <img src="https://www.anandsweets.in/cdn/shop/files/ecofriendly.svg?v=1684409308" alt="Trust Us" />
            </div>
        </div>
