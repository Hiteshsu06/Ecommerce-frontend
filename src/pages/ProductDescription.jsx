...
const ProductDescription = () => {
  ...
  const { id, image_url, description, name, variants, shelf_life } = location?.state || {};
    ...
    <>
      {loader ? <Loading/> :
        <>
          ...
          <div className="mx-16 p-4 mt-[5rem]">
              {/* Product Container */}
                  ...
                  <div>
                      ...
                      <div className="flex flex-col mt-8 md:flex-row justify-center gap-8 text-center">
                          {features?.map((feature, index) => (
                              <div key={feature?.id} className="flex flex-col items-center w-[30%]">
                      ...
                      <div>
                        ...
                        <div className='flex gap-2 mt-2'>
                            {variants?.map((item)=>{
                              return(
                                <div key={item?.id} onClick={()=>{ changeHandler(item?.weight)}} className='hover:cursor-pointer font-[600] border border-[#caa446] hover:bg-[#caa446] hover:text-white rounded-md overflow-hidden w-[100px] h-[50px] flex items-center justify-center'>
                                  {item?.weight}
                                </div>
                              )
                            })}
